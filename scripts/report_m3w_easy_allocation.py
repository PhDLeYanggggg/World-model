...
PUBLIC=ROOT/'outputs/publication_readiness_2026_09/easy_allocation_v1'
...
def figure(rows):
    ...
    fig.savefig(ROOT/'data/stage_cvpr2027_experiments/easy_allocation_v1/preview.png',dpi=130)
    plt.close(fig)
