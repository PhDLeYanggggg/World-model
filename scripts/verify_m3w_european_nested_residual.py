...
def main():
    ...
    tests = ['tests/test_m3w_nested_residual.py', 'tests/test_m3w_context_residual.py',
             ...
             'tests/test_m3w_nested_residual_reporting.py']
    ...
    bindings = sorted(set(run.FILES+tests+['scripts/plot_m3w_european_nested_residual.py',str(Path(__file__).relative_to(ROOT))]))
