...
def main() -> None:
    ...
    parser.add_argument("--mode", default="quick", choices=["quick", "data-first", "annotation-first", "train-deterministic", "full-auto", "overnight-stage13", "continuous-stage14", "continuous-stage15", "continuous-stage16"])
    ...
    if args.mode == "continuous-stage15":
        ...
        return
    if args.mode == "continuous-stage16":
        from .overnight_runner import run_continuous_stage16

        result = run_continuous_stage16(
            min_hours=args.min_hours,
            max_hours=args.max_hours,
            max_iterations=args.max_iterations,
            min_training_trials=args.min_training_trials,
