...
def _gate(payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    gates = {
        ...
        in {
            ...
            "stage43_bw_context_hazard_guard_pass_context_safe_lift_diagnostic",
            "stage43_bw_context_hazard_attribution_pass_floor_inherent_risk",
            "stage43_bw_context_hazard_attribution_pass_remaining_context_risk",
            "stage43_bx_latent_risk_head_robustness_pass",
            "stage43_bx_latent_risk_head_robustness_pass_horizon_caveat",
            "stage43_by_latent_transition_consistency_pass",
            "stage43_by_latent_transition_consistency_pass_with_slice_caveat",
            "stage43_by_latent_transition_consistency_pass_with_readout_caveat",
            "stage43_by_latent_transition_consistency_diagnostic_incomplete",
            ...
            "stage43_cb_downstream_easy_guard_pass",
            "stage43_cb_downstream_easy_guard_val_safe_test_easy_mismatch",
            "stage43_cb_downstream_easy_guard_diagnostic_incomplete",
            "stage43_cc_shadow_easy_guard_repair_pass",
            "stage43_cc_shadow_easy_guard_repair_partial_safe_lift",
            "stage43_cc_shadow_easy_guard_shadow_safe_test_mismatch",
            "stage43_cc_shadow_easy_guard_repair_diagnostic_incomplete",
            "stage43_cd_source_family_coverage_guard_pass",
            "stage43_cd_source_family_coverage_guard_partial_safe_lift",
            "stage43_cd_source_family_coverage_guard_diagnostic_incomplete",
            "stage43_ce_source_family_coverage_split_repair_ready",
            "stage43_ce_source_family_coverage_split_repair_partial",
            "stage43_cf_coverage_aware_full_waypoint_cache_ready",
            "stage43_cf_coverage_aware_full_waypoint_cache_incomplete",
            ...
            "stage43_cj_t100_long_horizon_specialist_pass_positive_t100",
            "stage43_cj_t100_long_horizon_specialist_pass_keep_ci_floor",
            "stage43_cj_t100_long_horizon_specialist_incomplete",
            "stage43_ck_t100_causal_feature_repair_pass_positive_t100",
            "stage43_ck_t100_causal_feature_repair_pass_keep_ci_floor",
            "stage43_ck_t100_causal_feature_repair_incomplete",
        },
