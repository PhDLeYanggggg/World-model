...
ETH_seq / UCY_students 仍不能写 positive calibrated t50 transfer。
...
UCY_students needs two more same-family calibrated support sources.
```
...
- `UCY_students`：需要额外合法同族 calibrated tracks。
...
calibrated-subset t50:
  ...
  ETH_seq / UCY_students positive transfer no, still source-support blocked
