# M3W Research History: September 2026

Snapshot of the detailed research record preserved during the source cross-fit
run on 2026-09-18. This is historical context, not a live progress page. Read
[the project overview](README.md) and [results ledger](README_RESULTS.md) for
current status. Negative results, limitations and old exploratory claims below
are retained without promoting them to independent confirmation.
