...
def _payload(*, overclaim: bool = False, ci_positive: bool = True) -> dict:
    ...
    return {
        ...
        "evidence_rows": [
            ...
            {"claim_name": "Bootstrap-supported delta over stored hard switch", "status": "supported"},
...
def test_gate_fails_when_bootstrap_delta_ci_is_not_positive() -> None:
    ...
    assert gate["gates"]["bootstrap_delta_claim_supported"] is False
