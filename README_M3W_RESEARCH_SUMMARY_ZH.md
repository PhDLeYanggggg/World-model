...
8. 当前最强可部署仍是 protected M3W-Neural v1 / Stage37-teacher-floor 路线，最新 Stage42-X/Y/Z/AA/AB/AD/AE/AF/AG/AH/AI/AJ 则提供 row-level full-waypoint cache、统一消融、论文 claim 边界、auxiliary-head mixed-evidence、标定证据刷新、weak-slice safety repair、ETH_UCY t50/FDE source repair、post-repair claim refresh、TrajNet t100 safety repair 和 paper package refresh。
