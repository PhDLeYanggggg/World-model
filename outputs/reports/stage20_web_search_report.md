...
| OpenTraj supported datasets | real_topdown_pedestrian_drone_official_benchmark | 95 | https://github.com/crowdbotp/OpenTraj | Provide OpenTraj local path or allow toolkit-only clone; verify underlying dataset licenses. |
...
| Stanford Drone Dataset | real_topdown_pedestrian_drone_official_benchmark | 90 | https://cvgl.stanford.edu/projects/uav_data/ | User must provide local SDD path after accepting Stanford non-commercial terms. |
