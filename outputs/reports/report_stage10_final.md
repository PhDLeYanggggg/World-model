...
3. 是否建立 human-confirmed gold/silver annotations：否 (human_confirmed=0)
4. 是否仍主要依赖 rule-confirmed silver：是 (silver_rule_confirmed=20)
...
human-confirmed annotation 是否建立：否
...
是否可以启用 SMC：否
当前 verdict：stage10_data_annotation_package_partial_not_stage11_ready
expert audit score：78
