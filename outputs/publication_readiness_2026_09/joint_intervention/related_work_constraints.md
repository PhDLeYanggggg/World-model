...
The subsequent [deferral review](deferral_and_coverage_prior_work.md) checks regression routing and subgroup damage; the [statistical assumption audit](statistical_assumptions_and_claims.md) checks hierarchical inference, whole-trajectory coverage and online motion-planning guarantees against our intended loss. Further work remains on the closest structured routing methods, cross-fitting under clustered sampling and forecasting under shift. These focused checks neither prove absence of an equivalent existing method nor establish CVPR readiness.
