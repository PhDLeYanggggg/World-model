...
- conclusion: continuous neural dynamics has strong all/t50/t100/hard signal, but easy degradation is far above the safety gate; this is not deployable and reveals that current train/val easy stress is not representative enough for non-fallback neural dynamics.
