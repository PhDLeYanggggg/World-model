...
## Safe-Switch Bounded Neural Blend Dynamics

- deployable: `True`
- selected policy: `teacher_repaired_switch, alpha=0.4`
- all/t50/t100/hard/easy: `0.11701273259955347` / `0.0901472737617619` / `0.08404585440914669` / `0.11458797966091572` / `0.0`
- alpha mean: `0.1181674110358738`
- switch/intervention rate: `0.2954185275896845`
- collision delta @0.05 normalized: `-0.001155581642760195`
- conclusion: safe-switch-only bounded blend proves a nonzero continuous neural dynamics contribution can be deployed under the repaired Stage37/teacher safety floor. It is an auxiliary dynamics head, not the best policy, because it trails the teacher-guided repaired switch on all and hard/failure.
